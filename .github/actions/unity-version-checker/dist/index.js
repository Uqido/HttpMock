...
async function main() {
    const projFile = (0,fs__WEBPACK_IMPORTED_MODULE_2__.readFileSync)('./ProjectSettings/ProjectVersion.txt', 'utf8');
    ...
    const response = await node_fetch__WEBPACK_IMPORTED_MODULE_1___default()('https://registry.hub.docker.com/v2/repositories/battlefieldnoob/unity-github-ci/tags?page_size=1024');
    ...
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput)("unity-version", matches[1]);
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput)("unity-changeset", matches[2]);
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput)("is-image-available", isAvailable);
}
